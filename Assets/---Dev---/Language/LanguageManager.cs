...
public class LanguageManager : MonoBehaviour
{
    ...
    [Header("Order - Memo")] [SerializeField]
    private string _orderTextFrench;

    [SerializeField] private string _orderTextEnglish;
    [Space(5)] [SerializeField] private string _memoTextFrench;
    [SerializeField] private string _memoTextEnglish;

    [Header("Recycle Menu")] [SerializeField]
    private string _recycleTextFrench;

    [SerializeField] private string _recycleTextEnglish;

    [Header("No Energy Text")] [SerializeField]
    private string _noEnergyTextFrench;

    [SerializeField] private string _noEnergyTextEnglish;

    [Header("Tile Bored Text")] [SerializeField]
    private string _boredTextFrench;

    [SerializeField] private string _boredTextEnglish;

    [Header("Victory - Defeat")] [SerializeField]
    private string _victoryTextFrench;

    [SerializeField] private string _victoryTextEnglish;
    [Space(5)] [SerializeField] private string _gameOverTextFrench;
    [SerializeField] private string _gameOverTextEnglish;

    [Header("Menu Victory - Defeat")] [SerializeField]
    private string _nextTextFrench;

    [SerializeField] private string _nextTextEnglish;

    [Space(10f)] [Header("--- Pause Menu ---")] [Space(10f)] [Header("Resume Button")] [SerializeField]
    private string _resumeTextFrench;

    [SerializeField] private string _resumeTextEnglish;

    [Header("Restart Button")] [SerializeField]
    private string _restartTextFrench;

    [SerializeField] private string _restartTextEnglish;

    [Header("Quit Button")] [SerializeField]
    private string _quitButtonTextFrench;

    [SerializeField] private string _quitButtonTextEnglish;

    [Space(10f)] [Header("--- Options ---")] [Space(10f)] [Header("Music")] [SerializeField]
    private string _musicTextFrench;

    [SerializeField] private string _musicTextEnglish;

    [Header("SFX")] [SerializeField] private string _sfxTextFrench;
    [SerializeField] private string _sfxTextEnglish;

    [Header("Controls")] [SerializeField] private string _controlTextFrench;
    [SerializeField] private string _controlTextEnglish;

    [Header("Language")] [SerializeField] private string _languageTextFrench;
    [SerializeField] private string _languageTextEnglish;

    [Header("Credits")] [SerializeField] private string _creditTextFrench;
    [SerializeField] private string _creditTextEnglish;

    [Header("Back Button")] [SerializeField]
    private string _backButtonTextFrench;

    [SerializeField] private string _backButtonTextEnglish;

    [Space(10f)] [Header("--- Menu Main Screen ---")] [Space(10f)] [Header("Play Button")] [SerializeField]
    private string _playButtonTextFrench;

    [SerializeField] private string _playButtonTextEnglish;

    [Header("Continue Button")] [SerializeField]
    private string _continueButtonTextFrench;

    [SerializeField] private string _continueButtonTextEnglish;

    [Header("New Game Button")] [SerializeField]
    ...
    [Header("Yes")] [SerializeField] private string _yesTextFrench;
    [SerializeField] private string _yesTextEnglish;

    [Header("No")] [SerializeField] private string _noTextFrench;
    [SerializeField] private string _noTextEnglish;

    [Space(10f)] [Header("--- Credits Screen ---")] [Space(10f)] [Header("Thanks for Playing")] [SerializeField]
    private string _thxForPlayinTextFrench;

    [SerializeField] private string _thxForPlayinTextEnglish;

    [Header("With Help of")] [SerializeField]
    private string _withHelpTextFrench;

    [SerializeField] private string _withHelpTextEnglish;

    [Header("Special Thanks")] [SerializeField]
